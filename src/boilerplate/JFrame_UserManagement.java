...
import boilerplate.Constants;

/**
 *
 * @author IT
 */
public class JFrame_UserManagement extends javax.swing.JFrame {

    JTable table;
    DefaultTableModel model;

    public JFrame_UserManagement() {
        initComponents();
    ...
    public static void main(String args[]) {
        JFrame_UserManagement jFrame_UserManagement = new JFrame_UserManagement();
        jFrame_UserManagement.setExtendedState(JFrame.MAXIMIZED_BOTH);
        jFrame_UserManagement.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        jFrame_UserManagement.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("kenhlaptrinh.net");
